...
|  pid.Init(0.1, 0, 1.0)| Success but unstable|
|  pid.Init(0.1, 0.00001, 2.0)| Success but unstable|
|  pid.Init(0.1, 0.00001, 3.0)| Success slightly stable|
|  pid.Init(0.1, 0.00001, 3.5)| (Adopted) Success |
